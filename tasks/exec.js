module.exports = function (grunt) {
    ...
    var config = {
        ...
        work_proof_of_identity: 'gpg -u <%= config.work_gpg_short_id %> -u <%= config.gpg_short_id %> -u <%= config.bgi_gpg_short_id %> --clearsign <%= config.uploads %>/proof-of-identity-work.txt',

        bgi_public_key: 'gpg --armor --export <%= config.bgi_gpg_short_id %> > <%= config.uploads %>/<%= config.bgi_gpg_short_id %>.asc',
        bgi_proof_of_identity: 'gpg -u <%= config.bgi_gpg_short_id %> -u <%= config.gpg_short_id %> -u <%= config.work_gpg_short_id %> --clearsign <%= config.uploads %>/proof-of-identity-braithwaite-network.txt',
